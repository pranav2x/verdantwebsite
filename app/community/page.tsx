    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto">
          <h1 className="font-serif text-4xl lg:text-6xl font-bold text-foreground mb-8">Join Our Community</h1>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <div className="bg-muted/50 rounded-lg p-6">
              <h2 className="text-2xl font-bold text-foreground mb-4">Discord Server</h2>
            ...
            <div className="bg-muted/50 rounded-lg p-6">
              <h2 className="text-2xl font-bold text-foreground mb-4">Reddit Community</h2>
              <p className="text-muted-foreground mb-4">
          ...
          <div className="bg-gradient-to-r from-green-500/10 to-blue-500/10 rounded-lg p-8 mb-8">
